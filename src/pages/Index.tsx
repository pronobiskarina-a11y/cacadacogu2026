    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-20 sm:py-24 bg-secondary/40">
        <div className="container">
          ...
          <Carousel opts={{ align: "start", loop: true }} className="max-w-3xl mx-auto">
            <CarouselContent>
              {[t1, t2, t3, t4, t5, t6].map((img, i) => (
                <CarouselItem key={i} className="basis-1/2 md:basis-1/3">
                  <div className="h-full p-1 rounded-xl bg-background border border-border hover:border-sienna/40 hover:shadow-soft transition-smooth overflow-hidden">
                    <img
                      src={img.url}
